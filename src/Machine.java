...
public class Machine {
	...
	public static void main(String[] args) {
        ...
        //Insert items to the menu
        snackVendingMachine.menu.put(new Integer(1), "Snickers");
        snackVendingMachine.menu.put(new Integer(2), "KitKat");
        snackVendingMachine.menu.put(new Integer(3), "DietCoke");
        snackVendingMachine.menu.put(new Integer(4), "Sprite");
        snackVendingMachine.menu.put(new Integer(5),"Skittles");
        snackVendingMachine.menu.put(new Integer(6),"Starbust");
        snackVendingMachine.menu.put(new Integer(7),"Muffin");
        ...
        snackVendingMachine.loadItems("Snickers", 2.0, 3);
        snackVendingMachine.loadItems("KitKat", 3.20, 7);
        snackVendingMachine.loadItems("Skittles", 1.75, 5);
        snackVendingMachine.loadItems("Muffin", 4.0, 15);
        snackVendingMachine.loadItems("Starbust", 1.5, 5);
        snackVendingMachine.loadItems("KitKat", 2.15, 12);
        snackVendingMachine.loadItems("DietCoke", 1.75, 30);
